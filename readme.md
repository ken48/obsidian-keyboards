...
Enter переехал на клавишу, которую теперь сложно нажать случайно. Стоит промахнуться — и сообщение улетает недописанным, а команда запускается раньше времени. В итоге получилось удачное сочетание точности указательного пальца и места, требующего более осознанного движения.
